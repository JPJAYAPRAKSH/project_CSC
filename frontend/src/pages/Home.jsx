...
function Home() {
    ...
    const loading = instituteLoading || coursesLoading;

    if (loading && !institute && featuredCourses.length === 0) {
        return (
                ...
                <div className="container">
                    <div className="hero-content fade-in">
                        ...
                        <h1 className="hero-title">
                            Welcome to <span className="text-gradient">CSC Computer Education</span>
                        </h1>
