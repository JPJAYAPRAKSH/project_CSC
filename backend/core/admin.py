...
class AttendanceAdmin(admin.ModelAdmin):
    list_display = ['student', 'date', 'is_present', 'check_in_time', 'check_out_time']
...
class AssessmentAdmin(admin.ModelAdmin):
    list_display = ['title', 'course', 'assessment_type', 'duration_minutes', 'total_marks', 'is_active']
    list_filter = ['course', 'assessment_type', 'is_active']
...
class AssessmentSubmissionAdmin(admin.ModelAdmin):
    list_display = ['student', 'assessment', 'score', 'percentage', 'status', 'submitted_at']
    list_filter = ['status', 'assessment', 'submitted_at']
    search_fields = ['student__first_name', 'student__last_name', 'assessment__title']
    readonly_fields = ['started_at', 'updated_at', 'submitted_at', 'graded_at']


@admin.register(Certificate)
class CertificateAdmin(admin.ModelAdmin):
    list_display = ['certificate_number', 'student', 'course', 'issue_date', 'grade']
