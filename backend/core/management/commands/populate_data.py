...
class Command(BaseCommand):
    help = 'Populate database with CSC Computer Education data'
    ...
    def create_institute_profile(self):
        ...
        profile, created = InstituteProfile.objects.get_or_create(
            ...
            defaults={
                ...
                'about': '''CSC Computer Education - Celebrating 38 years of excellence in computer education since 1986.
